...
local lua_name = "moriade.lua"
local lua_color = {r = 255, g = 255, b = 255}
local script_build = "debug"
...
client.color_log(lua_color.r, lua_color.g, lua_color.b, " moriade.lua")
...
local label = ui.new_label("AA", "Fake lag", "\a659F86FFMoriade.lua [debug]")
...
local menu = {
    ...
    configTab = {
        ...
        label1 = ui.new_label("AA", "Fake lag", "Welcome back \a659F86FF cvar1337"),
        label2 = ui.new_label("AA", "Fake lag", "Last update was \a659F86FF 21.09.2024"),
        label3 = ui.new_label("AA", "Fake lag", "Your build is \a659F86FFdebug [beta]"),
        ...
        buttonsd = ui.new_button("AA", "Other", "Join us", function() SteamOverlayAPI.OpenExternalBrowserURL("https://discord.gg/zPzDtxgDFX") end),
...
local function clantag_set()
    ...
    if ui.get(menu.miscTab.clanTag) then
        ...
        if entity.get_prop(entity.get_game_rules(), "m_gamePhase") == 5 then
            clan_tag = clantag_anim('cvar1337', {10})
...
local auto_discharge = function(cmd)
    if not ui.get(menu.miscTab.unsafecharhge) or ui.get(menu.miscTab.unsafecharhgekey) or ui.get(refs.quickPeek[2]) or not ui.get(refs.dt[2]) or 
